...
class DictionarySettingsTabTextSectionsTest {
    ...
    @Test
    fun `the definition show switch turns it off and back on`() = dictionaryTab { get ->
    ...
    fun `the definition colour field stores the confirmed hex`() {
        dictionaryTab(initial = dictionarySettings { copy(definitionColor = "#C0FFEE") }) { get ->
    ...
    @Test
    fun `the definition font size stores a new value`() = dictionaryTab { get ->
    ...
    @Test
    fun `a definition font size outside the range is not stored`() = dictionaryTab { get ->
    ...
    @Test
    fun `the KJV show switch turns it off and back on`() = dictionaryTab { get ->
    ...
    fun `the KJV colour field stores the confirmed hex`() {
        dictionaryTab(initial = dictionarySettings { copy(kjvUsageColor = "#010203") }) { get ->
    ...
    @Test
    fun `the KJV font size stores a new value`() = dictionaryTab { get ->
    ...
    @Test
    fun `a KJV font size above its narrower range is not stored`() = dictionaryTab { get ->
     ...
     */
    @Test
    fun `a size the KJV field rejects is accepted by the definition field`() = dictionaryTab { get ->
